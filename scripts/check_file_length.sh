...
SKIP="hands.py|validator.py|telemetry.py|halim_adapter.py|ib_cycle.py|orchestrator.py|ib_executor.py|ib_streamer.py|ironclad.py|juli.py|consolidation.py|shadow_book.py|ib_adapter.py|reflection/buffer.py|weights_config.py|realized_ev.py|config.py|immune.py|ev_gate.py|risk.py|exits.py|stdp.py|wfa.py|ablation.py|micro_live.py|phase7.py|phase8.py|phase9.py"
