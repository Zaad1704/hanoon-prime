...
class IBExecutor:
    ...
    def __init__(self, ib_client: Any, brain: Hippocampus,
                 journal: Journal, tracked_tickers: set[str] | None = None) -> None:
        self.ib = ib_client
        self.brain = brain
    ...
    def _ping_ib(self) -> bool:
        try:
            ...
            return False
    def _monitor_all_orders(self, ib_positions: dict[str, Position], streamer: Any) -> None:
    ...
    def _handle_parent(self, trade: Any, order: Any, sym: str,
                       ib_positions: dict[str, Position], streamer: Any) -> None:
    ...
    def _trail_both(self, sym: str, pos: Position, streamer: Any,
                    stop: float, target: float, trade: Any) -> None:
        """Trail BOTH stop and target as position moves in favor."""
    ...
    def _record_exit(self, ticker: str, streamer: Any) -> None:
        ...
        self._closed_trades.append({
            "ticker": ticker, "pnl": pnl, "return_pct": pnl,
