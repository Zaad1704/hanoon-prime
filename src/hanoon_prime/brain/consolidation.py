...
class ConsolidationEngine:
    ...
    def __init__(
        ...
        halim_url: str = HALIM_URL, interval: float = CYCLE_INTERVAL,
    ...
    def _sync_initial_state(self) -> None:
        ...
        self.state.update(threshold=self.memory.threshold,
    ...
    def _run_thinker(self) -> None:
        ...
        self.state.update(thinker_modifier=r.modifier,
    ...
    def _persist_data(self) -> dict[str, Any]:
        ...
        return {"weights": self.memory.get_weights(),
    ...
    def on_trade_close(self, ticker: str, won: bool, pnl_pct: float,
                       direction: int = 1, qty: float = 1.0,
                       avg_price: float = 0.0, fees: float = 0.0) -> None:
        ...
        self.buffer.on_fill(Fill(ticker=ticker, side=side, qty=qty,
                                 price=avg_price, time=time.time(),
                                 commission=fees))
