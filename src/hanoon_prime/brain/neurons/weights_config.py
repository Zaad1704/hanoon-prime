...
def _add_bull_weights(weights: Dict[str, float]) -> None:
    ...
    bull_to_trend = [
        ("bull_vpin_bull", 0.35),
        ("bull_momentum_bull", 0.40),
        ("bull_vwap_deviation_bull", 0.30),
        ("bull_orderbook_imbalance_bull", 0.45),
        ("bull_institutional_flow_bull", 0.50),
        ("bull_buy_volume_bull", 0.40),
        ("bull_bid_strength_bull", 0.35),
        ("bull_ask_strength_bull", 0.30),
        ("bull_volume_zscore_bull", 0.35),
        ("bull_price_momentum_bull", 0.40),
        ("bull_trend_strength_bull", 0.45),
        ("bull_liquidity_bull", 0.25),
        ("bull_order_imbalance_bull", 0.35),
        ("bull_flow_confidence_bull", 0.40),
        ("bull_mean_reversion_bull", 0.30),
    ]
    for src, w in bull_to_trend:
        weights[f"{src},hidden_trend"] = w
...
def _add_bear_weights(weights: Dict[str, float]) -> None:
    ...
    bear_to_vol = [
        ("bear_vpin_bear", 0.35),
        ("bear_momentum_bear", 0.30),
        ("bear_vwap_deviation_bear", 0.40),
        ("bear_orderbook_imbalance_bear", 0.45),
        ("bear_institutional_flow_bear", 0.35),
        ("bear_bid_strength_bear", 0.35),
        ("bear_ask_strength_bear", 0.40),
        ("bear_volume_zscore_bear", 0.35),
        ("bear_price_momentum_bear", 0.30),
        ("bear_trend_strength_bear", 0.30),
        ("bear_liquidity_bear", 0.35),
        ("bear_order_imbalance_bear", 0.40),
        ("bear_flow_confidence_bear", 0.30),
        ("bear_mean_reversion_bear", 0.25),
    ]
    for src, w in bear_to_vol:
        weights[f"{src},hidden_volatility"] = w
