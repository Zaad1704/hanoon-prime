...
def get_network_topology() -> Dict[str, list]:
    ...
    return {
        "input_to_hidden": [
            ...
            ("bull_vwap_deviation_bull", "hidden_trend"), ("bull_orderbook_imbalance_bull", "hidden_flow"),
            ("bull_institutional_flow_bull", "hidden_flow"), ("bull_buy_volume_bull", "hidden_conviction"),
            ...
            ("bear_vwap_deviation_bear", "hidden_volatility"), ("bear_orderbook_imbalance_bear", "hidden_conflict"),
            ("bear_institutional_flow_bear", "hidden_structure"), ("bear_bid_strength_bear", "hidden_volatility"),
            ("bear_ask_strength_bear", "hidden_volatility"), ("bear_volume_zscore_bear", "hidden_volatility"),
            ("bear_price_momentum_bear", "hidden_volatility"), ("bear_trend_strength_bear", "hidden_volatility"),
            ("bear_liquidity_bear", "hidden_volatility"), ("bear_order_imbalance_bear", "hidden_conflict"),
            ("bear_flow_confidence_bear", "hidden_structure"), ("bear_mean_reversion_bear", "hidden_volatility"),
        ],
        "hidden_to_decision": [
            ("hidden_trend", "decision_long", 0.45),
            ("hidden_flow", "decision_long", 0.35),
